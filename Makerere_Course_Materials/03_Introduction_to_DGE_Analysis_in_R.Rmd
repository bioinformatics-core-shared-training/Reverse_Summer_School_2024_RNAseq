...
* Total of 6 samples
* Question of interest: Which genes are differentially expressed between the two groups?
* N "independent" statistical tests - one for each gene
...
* n = sample size  
* Statistic is used to get *p-value* based on the theoretical distribution of
  the test statistic
* *p-value* is a function of the statistic
* The statistic is a function of the effect size and the sample variance
