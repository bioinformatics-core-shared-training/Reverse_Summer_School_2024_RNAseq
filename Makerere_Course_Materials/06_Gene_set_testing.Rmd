...
differences between groups than highly expressed genes. 

```{r unshrunkMA}
plotMA(results.interaction.11, alpha = 0.05)
```

The `lfcShrink` method compensates for this and allows better visualisation and
ranking of genes. 
...
This puts the most significantly up-regulated genes at the top of the list and
the most significantly down-regulated genes at the bottom of the list.
